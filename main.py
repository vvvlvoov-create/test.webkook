...
# Конфигурация  
BOT_TOKEN = '7719252121:AAEUyzzdo1JjYVfNv1uN_Y7PQFHR6de3T1o'  # Исправлено: убрали os.environ.get
CHANNEL_USERNAME = '@kfblackrussia'  # Юзернейм канала
CHAT_ID = '@kfblackrussia'  # ID чата для отправки сообщений
...
def main():
    """Основная функция"""
    if not BOT_TOKEN:
        logging.error("Не установлен BOT_TOKEN!")
        return
    ...
    # Добавляем задание для автоматической отправки сообщений
    job_queue = application.job_queue
    job_queue.run_repeating(auto_post_messages, interval=60, first=10)  # Проверка каждую минуту
